export function loadComponents (use, baseComponents = [], helpers) {
  ...
  const components = {
    ...
    formInput: () => import('../custom-elements/form-input/index.js').then(m => use(m.module, helpers)),
    formSelect: () => import('../custom-elements/form-select/index.js').then(m => use(m.module, helpers)),
    formTextarea: () => import('../custom-elements/form-textarea/index.js').then(m => use(m.module, helpers)),
